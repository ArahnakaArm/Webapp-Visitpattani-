      ...
      <v-card ref="form" >
        <v-card-text>
          ...
          <v-text-field
            ...
            label="Souvenir Name"
            placeholder="Please fill souvenir name."
            required
          ></v-text-field>
          <v-text-field 
            name="describtion"
          ...
          <v-text-field 
            ...
            required
          ></v-text-field>
          <h5 style="color:#808080;font-size:11.8px">รูปภาพสินค้า</h5>
...
let dataRef = db.ref('Travel-Product').child('TH');
let dataRefEn = db.ref('Travel-Product').child('EN');
export default {
